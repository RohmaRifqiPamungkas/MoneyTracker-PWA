...
export const BANK_PRESETS: BankPreset[] = [
  { id: "bca", name: "BCA", fullName: "Bank Central Asia", type: "bank", color: "#0066B3", logo: "/logos/BCA.png", gradient: ["#0066B3", "#004A82"] },
  { id: "mandiri", name: "Mandiri", fullName: "Bank Mandiri", type: "bank", color: "#1E3A5F", logo: "/logos/Mandiri.png", gradient: ["#1E3A5F", "#D4A017"] },
  { id: "blubca", name: "blu", fullName: "blu by BCA Digital", type: "bank", color: "#00A4E4", logo: "/logos/BluBCA.png", gradient: ["#00A4E4", "#0072A1"] },
  { id: "jago", name: "Jago", fullName: "Bank Jago", type: "bank", color: "#FFC107", logo: "/logos/BankJago.png", gradient: ["#FFC107", "#E0A800"] },
  { id: "seabank", name: "SeaBank", fullName: "Sea Bank Indonesia", type: "bank", color: "#FF5722", logo: "/logos/SeaBank.png", gradient: ["#FF5722", "#CC4419"] },
  { id: "krom", name: "Krom", fullName: "Krom Bank Indonesia", type: "bank", color: "#6200EE", logo: "/logos/Krom.png", gradient: ["#6200EE", "#3700B3"] },
  { id: "superbank", name: "Superbank", fullName: "Superbank Indonesia", type: "bank", color: "#8E24AA", logo: "/logos/SuperBank.png", gradient: ["#8E24AA", "#5C1371"] },
  { id: "bri", name: "BRI", fullName: "Bank Rakyat Indonesia", type: "bank", color: "#005BAC", logo: "/logos/BRI.png", gradient: ["#005BAC", "#003F7A"] },
  { id: "bni", name: "BNI", fullName: "Bank Negara Indonesia", type: "bank", color: "#FF6600", logo: "/logos/BNI.png", gradient: ["#FF6600", "#CC5200"] },
  { id: "cimb", name: "CIMB", fullName: "CIMB Niaga", type: "bank", color: "#C8102E", logo: "/logos/CIMB.png", gradient: ["#C8102E", "#960C22"] },
  { id: "gopay", name: "GoPay", fullName: "GoPay by GoTo", type: "ewallet", color: "#00AA13", logo: "/logos/Gopay.png", gradient: ["#00AA13", "#007D0E"] },
  { id: "ovo", name: "OVO", fullName: "OVO", type: "ewallet", color: "#4B1C8D", logo: "/logos/Ovo.png", gradient: ["#4B1C8D", "#320D60"] },
  { id: "dana", name: "DANA", fullName: "DANA Indonesia", type: "ewallet", color: "#108EE9", logo: "/logos/Dana.png", gradient: ["#108EE9", "#0E7AC9"] },
  { id: "shopee", name: "ShopeePay", fullName: "ShopeePay", type: "ewallet", color: "#EE4D2D", logo: "/logos/Shopee.png", gradient: ["#EE4D2D", "#CC3D20"] },
...
export const CATEGORY_META: Record<string, { label: string; emoji: string; color: string }> = {
  ...
  coffee: { label: "Kopi & Nongkrong", emoji: "☕", color: "#78350f" },
  education: { label: "Edukasi & Buku", emoji: "📚", color: "#6366f1" },
  charity: { label: "Donasi & Zakat", emoji: "⛑️", color: "#f97316" },
  selfcare: { label: "Perawatan Diri", emoji: "✨", color: "#df168a" },
  emergency: { label: "Dana Darurat", emoji: "🚨", color: "#ef4444" },
  saving: { label: "Tabungan", emoji: "🐷", color: "#db2777" },
